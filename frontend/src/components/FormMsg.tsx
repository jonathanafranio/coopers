...
const FormMsg = () => {
    ...
    return(
        <form action="" className="form-msg">
            ...
            <div className="form-msg__wrap -two-ipts">
                <div className="form-msg__field">
                    <label htmlFor="email-field" className="form-msg__label">Email*</label>
                    <input 
                        type="email" 
                        name="email-field" 
                        id="email-field" 
                ...
                <div className="form-msg__field">
                    <label htmlFor="tel-field" className="form-msg__label">Telephone*</label>
                    <input 
                        type="tel" 
                        name="tel-field" 
                        id="tel-field" 
            ...
            <div className="form-msg__wrap">
                <div className="form-msg__field">
                    <label htmlFor="msg-field" className="form-msg__label">Message*</label>
                    <textarea 
                        name="msg-field" 
                        id="msg-field" 
            ...
            <button className="form-msg__btn" disabled={ btnDisable }>SEND NOW</button>
        </form>
    )
}
